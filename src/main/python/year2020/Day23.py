...
if CUP_COUNT > 9:
    [cup_ring.append(number) for number in range(10, 1000001)]
...
print("Coin hideouts:", cup_ring[position1 + 1], cup_ring[position1 + 2], "product:", cup_ring[position1 + 1] * cup_ring[position1 + 2])
